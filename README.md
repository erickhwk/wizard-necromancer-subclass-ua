...
- **Foundry VTT v13 or higher** (verified on v14). On v13, the subclass may not surface in the Compendium Browser depending on the dnd5e system version; drag it directly from the pack onto the character if needed.
